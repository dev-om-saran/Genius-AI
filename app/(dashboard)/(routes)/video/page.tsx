  ...
  return (
    <div>
      <Heading 
        ...
        description="Thoughts into motion on your screen"
        icon={VideoIcon}
      ...
      <div className="px-4 lg:px-8">
                  ...
                  <FormItem className="col-span-12 lg:col-span-8">
                    <FormControl>
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="Ice melting in Antarctica"
                        autoComplete="off"
                        {...field}
                      />
                    </FormControl>
        ...
        <div className="space-y-4 mt-4">
            ...
            {video && video.length ==0 && !isLoading && (
                <Empty label = "Enter prompt to generate video"/>
            )}
